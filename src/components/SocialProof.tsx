  ...
  return (
    ...
    >
      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-24">
        ...
        {/* O TESTIMONIAL (A aspa matadora) */}
        <div className="proof-reveal flex max-w-4xl flex-col items-center text-center">
          <svg
            className="mb-6 h-10 w-10 text-zinc-700"
            fill="currentColor"
            viewBox="0 0 32 32"
            aria-hidden="true"
          >
          ...
          <p className="text-2xl font-light leading-relaxed text-zinc-300 md:text-4xl">
            &ldquo;A FlyAI não entregou um software. Eles implementaram uma{" "}
            <span className="font-medium text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]">
              espinha dorsal inteligente
            </span>{" "}
            que substituiu nosso gargalo braçal e reduziu nosso custo
            operacional quase a zero.&rdquo;
          </p>
          <div className="mt-8 flex items-center gap-4">
            ...
            <div className="text-left">
              ...
              <p className="text-xs text-zinc-500">Tech/Enterprise Sector</p>
            </div>
          </div>
        </div>
      </div>
